...
```
git clone https://github.com/9twy/crypto-is-awesome.git
cd foundry-fund-me
make
```
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#github.com/9twy/crypto-is-awesome.git)
